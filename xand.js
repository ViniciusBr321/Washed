      ...
      <SafeAreaView>
        ...
        <View style={styles.filtroresultados}>
          ...
          <View style={styles.abalavajatos1}>
            <Image style={styles.imagemlavato1} source={require('./assets/1.png')}/>
            <View>
          ...
          <View style={styles.abalavajatos2}>
            <Image style={styles.imagemlavato2} source={require('./assets/2.png')} />
            <View>
          ...
          <View style={styles.abalavajatos3}>
            <Image style={styles.imagemlavato3} source={require('./assets/ViaLactea.png')} />
            <View>
