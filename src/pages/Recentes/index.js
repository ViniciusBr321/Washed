    ...
    return(
      <View style={{flex: 1}}>
          ...
          <View style={styles.opcoesCabecalho}>
            ...
            <TouchableOpacity style={{backgroundColor: '#FF6B00',width: '34%',height: 35,alignItems: 'center',justifyContent: 'center'}}  onPress={() => navigation.navigate('Recentes')}>
              <Text style={{color: 'white'}}>Recentes</Text>
            </TouchableOpacity>
